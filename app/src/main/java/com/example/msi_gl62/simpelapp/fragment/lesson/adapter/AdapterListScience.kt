...
import com.example.msi_gl62.simpelapp.fragment.lesson.holder.ListLessonScienceHolder
import com.example.msi_gl62.simpelapp.model.Lesson
import com.example.msi_gl62.simpelapp.model.Teacher

class AdapterListScience(private var coWork: List<Lesson>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
            ListLessonScienceHolder(LayoutInflater.from(parent.context).inflate(viewType, parent, false))

    override fun getItemCount(): Int = coWork.size

    override fun getItemViewType(position: Int): Int = R.layout.item_theme_lesson

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) = (holder as ListLessonScienceHolder).onBind(coWork[position])
